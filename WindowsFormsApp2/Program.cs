...
namespace WindowsFormsApp2
{
    ...
    internal static class Program
    {
        ...
        {
            string connectionString = "server=localhost;user=root;password=Yuhu7326@;database=Admins;";
            ...
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = "SELECT COUNT(*) FROM ad WHERE username = @username AND password = @password";
